...
pthread_t motSerThread, motConnThread, conPGateway, chkAliveThread;
...
{	
	...
	file3 = argv[3];
/****
	file1 = "MotionSensorConfiguration.txt";
	file2 = "output/MotionInput.txt";
	file3 = "output/MotionOutput.log";
/****/	
...
void * checkAliveGateway()
{
	...
	server_alternate.sin_port = htons( 8091 );
